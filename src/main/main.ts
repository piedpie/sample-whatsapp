...
async function startWhatsappClient() {
  ...
  client.on('ready', async () => {
    mainWindow.webContents.send('ready', client.info);
  });
  ...
  client.on('disconnected', async (waState: WAState) => {
    console.log('disconnected');
    mainWindow.webContents.send('disconnected', waState);
  });
...
ipcMain.on('start_whatsapp_client', async () => {
